...
class Program
{
    ...
    public static void ParsePacket(XmlReader r)
    {
        ...
        {
            Console.WriteLine("Invalid node type or name. Expected 'packet'.");
            return;
        }
        ...
        {
            Console.WriteLine("Packet name is missing.");
            return;
        }
    ...
    public static Tuple<string, string, string> ParseMembers(XmlReader r)
    {
        ...
        while (r.Read())
        {
            ...
            {
                Console.WriteLine("Member name is missing.");
                return null;
            }
    ...
    public static Tuple<string, string, string> ParseList(XmlReader r)
    {
        ...
        {
            Console.WriteLine("List name is missing.");
            return null;
        }
